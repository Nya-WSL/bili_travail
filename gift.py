...
def get_gift(room_id, path: str, json_path = "data/gift_img.json", h5_path = "data/saved_page.html", show = False, write = True, time: Union[int, float] = 0, write_time = False, return_dict = False, init = False):
    """
    爬取并解析B站直播间礼物标签和URL，保存为JSON文件
    :param room_id: 房间号
    :param path: 保存JSON文件的路径
    :param json_path: get_bili_h5()的json文件的路径
